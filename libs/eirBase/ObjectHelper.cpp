...
bool ObjectHelper::isValidEnumName(const CText &enumName) const
{
    const QMetaEnum cMetaEnum = metaEnum(enumName);
    return cMetaEnum.isValid();
}

bool ObjectHelper::isValidEnumKey(const CText &enumName, const CText &key) const
{
    bool result = false;
    const QMetaEnum cMetaEnum = metaEnum(enumName);
...
bool ObjectHelper::setEnum(const CText &enumName,
                           const CText &enumKey)
{
